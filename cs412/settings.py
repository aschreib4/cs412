...
SECRET_KEY = 'django-insecure-bf-3@!9fnopbjdmuyz(ssdu!$l9f5nyo6r34-c4(h(3ugu)9!*'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            "string_if_invalid": "WARNING: {{%s}} not a valid context variable", #new
            'context_processors': [
...
if socket.gethostname() == CS_DEPLOYMENT_HOSTNAME:
    STATIC_URL = '/aschreib/static/'
    MEDIA_URL = '/aschreib/media/'